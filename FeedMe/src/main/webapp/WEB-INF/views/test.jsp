...
<body>
	...
	<script
		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB6CaUv5C6-tT2QBEdgJLt2bpAR18ZAbf4&libraries=places&callback=initAutocomplete"
		async defer></script>
</body>
</html>